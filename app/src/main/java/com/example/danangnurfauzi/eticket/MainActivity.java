            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String jenisUser = user.getString("jenisUser");
                        String userAksesLoker = user.getString("userAksesLoker");
                        String pAksesLoker = user.getString("pAksesLoker");

                        // Inserting row in users table
                        db.addUser(name, jenisUser, userAksesLoker, pAksesLoker);
